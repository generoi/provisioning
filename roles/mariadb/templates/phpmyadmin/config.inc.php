 ...
 * cookie
 */
$cfg['blowfish_secret'] = '{{ pma_blowfish_secret.output }}'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
$cfg['Servers'][$i]['AllowDeny']['rules'] = 'localhost';
{% endif }
 ...
 * tree.
 */
$cfg['NavigationTreeDisplayItemFilterMinimum'] = 9999;
$cfg['NavigationTreeDisplayDbFilterMinimum'] = 9999;
